...
var WheelPicker = /** @class */ (function (_super) {
    ...
    WheelPicker.prototype.render = function () {
        var _this = this;
        return (React__default.createElement("div", { className: "picker-container" },
            React__default.createElement("div", { className: "picker-wrapper", ref: this.containerRef },
                React__default.createElement("div", { className: "picker-scroller", onTouchStart: this.onStart, onTouchMove: this.onMove, onTouchEnd: this.onEnd, onMouseDown: this.onStart, onMouseMove: this.onMove, onMouseLeave: this.onEnd, onMouseUp: this.onEnd, style: {
